...
public class HotelElements {
	...
	By e_daten = By.cssSelector("div[data-testid='openCheckinCalendar'] h4[class='dwebCommonstyles__SmallSectionHeader-sc-112ty3f-7 SearchBlockUIstyles__CheckInDateWrapDiv-sc-fity7j-14 hAEfdZ kSflmU']");
	...
	By e_viewRoomOpt = By.xpath("(//button[@class='dwebCommonstyles__ButtonBase-sc-112ty3f-10 BookingWidgetstyles__ViewRoomOptionsButton-sc-1tsb1-10 KETBj iiLDmi'])[1]");
	By e_hotelClick = By.xpath("(//button[@data-testid='selectRoomBtn'])[1]");
	By r_min= By.xpath("(//span[@class='PaxWidgetstyles__ContentActionIconWrapperSpan-sc-gv3w6r-8 dxKRvV'][normalize-space()='-'])[1]");
	By r_max= By.xpath("(//span[@class='PaxWidgetstyles__ContentActionIconWrapperSpan-sc-gv3w6r-8 dxKRvV'][normalize-space()='+'])[1]");
	By a_min= By.xpath("(//span[@class='PaxWidgetstyles__ContentActionIconWrapperSpan-sc-gv3w6r-8 dxKRvV'][normalize-space()='-'])[2]");
	By a_max= By.xpath("(//span[@class='PaxWidgetstyles__ContentActionIconWrapperSpan-sc-gv3w6r-8 dxKRvV'][normalize-space()='+'])[2]");
	By c_min =By.xpath("(//span[@class='PaxWidgetstyles__ContentActionIconWrapperSpan-sc-gv3w6r-8 dxKRvV'][normalize-space()='-'])[3]");
	By c_max =By.xpath("(//span[@class='PaxWidgetstyles__ContentActionIconWrapperSpan-sc-gv3w6r-8 dxKRvV'][normalize-space()='+'])[3]");
	...
	public void setLocation(String loca) throws Exception{
		driver.findElement(e_loc).sendKeys(loca);Thread.sleep(1000);					//for setting the location
		driver.findElement(e_loc).sendKeys(Keys.ARROW_DOWN);Thread.sleep(1000);
		driver.findElement(e_loc).sendKeys(Keys.ENTER);Thread.sleep(1000);
	}
