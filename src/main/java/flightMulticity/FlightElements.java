...
public class FlightElements {
	...
	By e_from = By.xpath("//div[@class='col-md-12 pad0 dF flexWrap brdrRd5 marginB10 fltHpySrchWrp whiteBg']//input[@id='gosuggest_inputSrc']");
	By e_to = By.xpath("//div[@class='col-md-12 pad0 dF flexWrap brdrRd5 marginB10 fltHpySrchWrp whiteBg']//input[@id='gosuggest_inputDest']");//div[@class='col-md-12 pad0 dF flexWrap brdrRd5 marginB10 fltHpySrchWrp whiteBg']//input[@id='gosuggest_inputDest']
	...
	By e_risk = By.cssSelector(".dweb-commonstyles__ButtonBase-sc-13fxsy5-4.dweb-commonstyles__InsuranceButton-sc-13fxsy5-5.dweb-commonstyles__InsuranceUnselectButton-sc-13fxsy5-7.ggCItP.NqvXb.jpQHoV");
	...
	By e_pay = By.xpath("//button[@class='width100 ico14 padLR20 white button hpyOrangeBg large txtCenter marginT15 brdrTLR0 padTB5 bkPgPrcd']");
